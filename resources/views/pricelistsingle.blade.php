    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLabel">تحويل الي فاتورة الان</h5>
          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
          </button>
        </div>
        <form action="{{Route('convertToFatorah', $show->id)}}">
        @csrf
        <div class="modal-body">
          ...
          <div class="form-group">
            <label for="name">خصم من </label>
            <div class="form-group">
              <label for="exampleFormControlSelect1">اختار المستودع</label>
              <select class="form-control" name="minus" id="exampleFormControlSelect1">
                <option value="one">المستودع</option>
                <option value="two">نقطة البيع</option>
              </select>
            </div>
